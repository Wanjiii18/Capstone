...
@section('stats')
{{-- Optionally add stats specific to Meals here --}}
@endsection
...
<div class="bg-white p-4 rounded-lg shadow mb-6">
    <div class="flex space-x-4 border-b pb-2">
        ...
        <a href="{{ route('dashboard.meals') }}" class="text-blue-600 border-b-2 border-blue-600 pb-1">Meals</a>
...
<div class="bg-white p-4 rounded-lg shadow">
    ...
    <p>Content for Meals dashboard goes here.</p>
</div>
@endsection
